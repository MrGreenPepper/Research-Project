...
Parameter
*forecast prices
p_RL_in(s_RL_in)                    /s_RL_in1 90, s_RL_in2 100, s_RL_in3 110/
...
eq_profit_RL_in_..                      Profit_RL_in =e= sum(s_RL_in, p_RL_in(s_RL_in) * X_RL_in(s_RL_in) * w_RL_in(s_RL_in));
eq_profit_RL_out_..                     Profit_RL_out =e= sum(s_RL_out, p_RL_out(s_RL_out) * X_RL_out(s_RL_out) * w_RL_out(s_RL_out));
...
*storage const
store_RL_in1..                sum(s_RL_in, X_RL_in(s_RL_in)) =g= 0;
store_RL_out1..              sum(s_RL_out, X_RL_out(s_RL_out)) =g= 0;
...
store_RL_in2..                sum(s_RL_in, X_RL_in(s_RL_in)) =l= r;
store_RL_out2..              sum(s_RL_out, X_RL_out(s_RL_out)) =l= r;
