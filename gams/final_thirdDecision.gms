...
q_DA(s_DA)                                  /s_DA1 100,     s_DA2 0,        s_DA3 0/
...
profitEQ..      Profit  =e=
                ...
                + sum(s_DA, q_DA(s_DA) * p_DA(s_DA) * B_DA(s_DA) )
...
marketBidCon_c_in_RL1(s_in_RL)..    yc_in_RL =l= p_in_RL(s_in_RL) + M * B_in_RL(s_in_RL);
...
marketBidCon_c_out_DA1(s_DA)..      c_DA =l= p_DA(s_DA) + M * B_DA(s_DA);
marketBidCon_c_out_DA2(s_DA)..      c_DA =g= p_DA(s_DA) - M * (1 - B_DA(s_DA));
