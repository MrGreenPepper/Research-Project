...
Parameters
omega_RL_in(t_block, s_in_RL)                        /s_in_RL1 0.7, s_in_RL2 0.5, s_in_RL3 0.3/
omega_RL_out(t_block, s_out_RL)                      /s_out_RL1 0.7, s_out_RL2 0.5, s_out_RL3 0.3/
omega_DA(t_hour, s_DA)                              /s_DA1 0.7, s_DA2 0.5, s_DA3 0.3/
omega_RA_in(t_quarter, s_in_RA)                         /s_in_RA1 0.7, s_in_RA2 0.5, s_in_RA3 0.3/
omega_RA_out(t_quarter, s_out_RA)                      /s_out_RA1 0.7, s_out_RA2 0.5, s_out_RA3 0.3/
p_in_RL(t_block, s_in_RL)                            /s_in_RL1 90, s_in_RL2 100, s_in_RL3 110/
p_out_RL(t_block, s_out_RL)                          /s_out_RL1 90, s_out_RL2 100, s_out_RL3 110/
p_DA(t_hour, s_DA)                                  /s_DA1 90, s_DA2 100, s_DA3 110/
p_in_RA(t_quarter, s_in_RA)                             /s_in_RA1 90, s_in_RA2 100, s_in_RA3 110/
p_out_RA(t_quarter, s_out_RA)                          /s_out_RA1 90, s_out_RA2 100, s_out_RA3 110/
;
