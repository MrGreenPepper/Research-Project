...
marketBidCon_c_in_RL
marketBidCon_c_in_RL
marketBidCon_c_out_RL
marketBidCon_c_out_RL
;
...
marketBidCon_c_in_RL(s_in_RL).. c_in_RL =l= p_in_RL(s_in_RL) + M * B_in_RL(s_in_RL);
marketBidCon_c_in_RL(s_in_RL).. c_in_RL =g= p_in_RL(s_in_RL) - M * (1 - B_in_RL(s_in_RL));
marketBidCon_c_out_RL(s_out_RL).. c_out_RL =l= p_out_RL(s_out_RL) + M * B_out_RL(s_out_RL);
marketBidCon_c_out_RL(s_out_RL).. c_out_RL =g= p_out_RL(s_out_RL) - M * (1 - B_out_RL(s_out_RL));
